package com.destroystokyo.youcantfindpaper.proxy;
...
public class VelocityProxy {
    ...
    public static boolean checkIntegrity(final FriendlyByteBuf buf) {
        ...
        try {
            ...
            mac.init(new SecretKeySpec(MagmaConfig.instance.paperVelocitySecret.getValues().getBytes(java.nio.charset.StandardCharsets.UTF_8), "HmacSHA256"));
