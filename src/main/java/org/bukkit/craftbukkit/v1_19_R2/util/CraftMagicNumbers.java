...
public final class CraftMagicNumbers implements UnsafeValues {
    ...
    public static BlockState getBlock(Material material, byte data) {
        return org.bukkit.craftbukkit.v1_19_R2.legacy.CraftLegacy.fromLegacyData(
            org.bukkit.craftbukkit.v1_19_R2.legacy.CraftLegacy.toLegacy(material), data);
    }

    public static MaterialData getMaterial(BlockState data) {
        return org.bukkit.craftbukkit.v1_19_R2.legacy.CraftLegacy.toLegacy(getMaterial(data.getBlock())).getNewData(toLegacyData(data));
    }
    ...
    public static MaterialData getMaterialData(Item item) {
        return org.bukkit.craftbukkit.v1_19_R2.legacy.CraftLegacy.toLegacyData(getMaterial(item));
    }
    ...
    public static Item getItem(Material material) {
        if (material != null && material.isLegacy()) {
            material = org.bukkit.craftbukkit.v1_19_R2.legacy.CraftLegacy.fromLegacy(material);
        }
    ...
    public static byte toLegacyData(BlockState data) {
        return org.bukkit.craftbukkit.v1_19_R2.legacy.CraftLegacy.toLegacyData(data);
    }

    @Override
    public Material toLegacy(Material material) {
        return org.bukkit.craftbukkit.v1_19_R2.legacy.CraftLegacy.toLegacy(material);
    }
    ...
    public Material fromLegacy(MaterialData material, boolean itemPriority) {
        return org.bukkit.craftbukkit.v1_19_R2.legacy.CraftLegacy.fromLegacy(material, itemPriority);
    }
    ...
    public Multimap<Attribute, AttributeModifier> getDefaultAttributeModifiers(Material material, EquipmentSlot slot) {
        ...
        Multimap<net.minecraft.world.entity.ai.attributes.Attribute, net.minecraft.world.entity.ai.attributes.AttributeModifier> nmsDefaultAttributes = getItem(material).getDefaultAttributeModifiers(
