...
public final class CraftMagicNumbers implements UnsafeValues {
    ...
    public static BlockState getBlock(Material material, byte data) {
        return org.bukkit.craftbukkit.v1_19_R3.legacy.CraftLegacy.fromLegacyData(
            org.bukkit.craftbukkit.v1_19_R3.legacy.CraftLegacy.toLegacy(material), data);
    }

    public static MaterialData getMaterial(BlockState data) {
        return org.bukkit.craftbukkit.v1_19_R3.legacy.CraftLegacy.toLegacy(getMaterial(data.getBlock())).getNewData(toLegacyData(data));
    }
