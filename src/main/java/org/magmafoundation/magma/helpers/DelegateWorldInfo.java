...
public class DelegateWorldInfo extends PrimaryLevelData {
    ...
    public DelegateWorldInfo(LevelSettings p_251081_, WorldOptions p_251666_, Lifecycle p_251714_, DerivedLevelData derivedLevelData, PrimaryLevelData.SpecialWorldProperty specialWorldProperty) {
