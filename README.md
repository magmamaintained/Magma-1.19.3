...
1. Download the recommended builds from the [**Releases** section](https://github.com/magmamaintained/Magma-1.19.3/releases) (**Download** the one that ends in server) 
   1. Or Download the latest jar from [Magma Maintained Site](https://magmamaintained.org/)
