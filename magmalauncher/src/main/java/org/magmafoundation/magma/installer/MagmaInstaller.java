...
public class MagmaInstaller extends AbstractMagmaInstaller {
    ...
    private record InternalDependency(File file, String path, String signature) {
        ...
        private void download() throws Exception {
            try {
                NetworkUtils.downloadFile("https://nexus.c0d3m4513r.com/repository/Magma-1.19/" + path, file, this.signature());
            } catch (Throwable e) {
    ...
    protected class Dependencies {
        ...
        public void downloadLibraries() throws Exception {
            ...
            standardRepositories.add(new StandardRepository("https://nexus.c0d3m4513r.com/repository/Magma-1.19/"));
